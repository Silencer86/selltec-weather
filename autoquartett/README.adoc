...
<2> Constructor für Klasse Auto in dem der Hersteller beim Erzeugen des Objekte gesetzt wird

### Aufgabe 2

1. Erszeuge Constructoren für alle Klassen
2. Mache alle Attribute, die nach dem Erzeugen eines Ojekte nicht mhr verändert werden `final`
